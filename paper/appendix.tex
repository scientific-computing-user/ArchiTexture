...
\begin{figure*}[t]
    ...
    \caption{Supporting proposal-/mask-space examples on the ControlNet bridge route. The proposal-union view often leaks across the stitched transition or over-broadens the generator boundary, which explains why overlap can look reasonable while ARI remains fragile. The learned readout is more conservative, but this route remains appendix-only because the paper does not establish a causal bridge-training advantage.}
...
\begin{figure*}[t]
    ...
    \caption{Supporting proposal-/mask-space breadth check on CAID. The same frozen-bank consolidation logic remains useful under shoreline structure, but this route is not central to the paper's texture claim and is reported only as an appendix-side generalization check.}
    \label{fig:caid_app}
\end{figure*}
