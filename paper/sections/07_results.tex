...
The ADE20K-selected complement widens the natural-image side with our separately released curated textural crops. Because the released TextureSAM checkpoint was trained on ADE20K, the paper uses the validation slice of that release and reports the matched checkpoint subset for the strictest comparison. Under that view, the proposal route improves the invariant readout from 0.4715 / 0.3306 to 0.5043 / 0.3762. This matters because it shows that the frozen-bank story is not confined to the older small natural benchmark: it survives on a broader released crop route whose texture transitions were selected visually rather than inherited from the historical RWTD protocol. Appendix~\ref{app:detexture_secondary} adds the route-construction note, qualitative audit, and secondary direct-versus-invariant view.
