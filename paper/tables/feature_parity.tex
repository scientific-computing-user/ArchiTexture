...
\caption{Archived frozen-feature parity summary from the site bundle. Each cell is reported as mIoU / ARI. This table is diagnostic only and is not used as a matched comparison to the proposal-space evaluator.}
