...
\toprule
\textbf{Algorithm 1: proposal-space inference over the frozen mask bank for image $x$} \\
\midrule
...
\bottomrule
\end{tabularx}
\caption{Compact pseudocode for the deployed decision layer. The ADE20K-selected complement, STLD, the ControlNet bridge complement, and the appendix CAID route stop after Step~4 because they do not use the RWTD rescue layer.}
