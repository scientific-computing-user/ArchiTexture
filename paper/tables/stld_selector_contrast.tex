...
\bottomrule
\end{tabularx}
\caption{Compact cross-dataset answer to \textbf{RQ4}. RWTD and STLD use different evaluators, so the point is not absolute scale but the different role played by singleton selection on the two routes.}
